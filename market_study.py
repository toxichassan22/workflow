...
SOURCE_PRIORITY = {
    1: [
        ...
        'المؤشر التفصيلي لسوق الإيجار sakani.sa/reports-and-data/rental-units — جداول إيجار الوحدات السكنية والتجارية حسب المدينة والحي',
    ...
    3: [
        ...
        'ValuStrat', 'Deloitte', 'PwC', 'KPMG', 'EY', 'STR أو CoStar للفنادق',
    ],
    4: [
    ...
    5: [
        'Google Maps للمواقع والمسافات والخدمات',
...
TYPE_SOURCE_PRIORITY = {
    'سكني': [
        ...
        'المؤشر التفصيلي لسوق الإيجار sakani.sa/reports-and-data/rental-units',
        'الهيئة العامة للإحصاء',
        'البنك المركزي السعودي',
        'وافي',
        'سكني وNHC',
    ...
    'تجاري': [
        'منصة المؤشرات العقارية rei.rega.gov.sa وشبكة إيجار',
        'المؤشر التفصيلي لسوق الإيجار sakani.sa/reports-and-data/rental-units — جداول الوحدات التجارية',
        'الهيئة العامة للإحصاء',
        'وزارة التجارة',
        'الأمانة وبلدي',
        'البنك المركزي السعودي',
...
def build_competitors_user_prompt(payload, existing_competitors, mode='generate'):
    ...
    search_protocol = (
        ...
        'التفصيلي لسوق الإيجار من سكني (site:sakani.sa/reports-and-data/rental-units) واسحب جداول '
