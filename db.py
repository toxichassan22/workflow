...
PREBUILT_FIELDS = [
    ...
    {'key': 'approved_floor_count', 'label': 'الأدوار المعتمدة', 'type': 'number', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'عدد الأدوار الفعلي الذي يعتمده العميل للمبنى — يكتبه العميل فقط ولا يملؤه AI', 'sort_order': 24},
    {'key': 'allowed_uses_restrictions', 'label': 'الاستخدامات المسموحة والقيود التنظيمية', 'type': 'textarea', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'الأنشطة والاستخدامات المسموحة والاشتراطات الخاصة', 'sort_order': 25},
    ...
    {'key': 'land_and_building_summary', 'label': 'ملخص بيانات الأرض والاشتراطات', 'type': 'textarea', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'ملخص واسترسال تحليلي شامل لبيانات الأرض واشتراطات البناء التنظيمية والفرص والأنشطة المسموحة', 'sort_order': 28},
