...
PREBUILT_FIELDS = [
    ...
    {'key': 'location_address', 'label': 'رابط موقع الأرض في Google Maps', 'type': 'text', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'رابط Google Maps مباشر لنقطة الأرض؛ يستخدم لتحديد الإحداثيات والبلدية والاشتراطات المرتبطة بالموقع', 'sort_order': 9},
