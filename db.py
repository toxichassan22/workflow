...
PREBUILT_FIELDS = [
    ...
    {'key': 'allowed_uses', 'label': 'الاستخدامات المسموحة', 'type': 'textarea', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'يملؤه AI بعد مقارنة نوع المشروع بالموقع وملفات الأمانة كاملة؛ يبدأ بحالة واضحة: مسموح أو غير مسموح أو غير محسوم، ثم يذكر الاستخدامات المسموحة', 'sort_order': 26},
