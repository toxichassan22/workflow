...
PREBUILT_FIELDS = [
    ...
    {'key': 'facades_count', 'label': 'عدد الواجهات', 'type': 'number', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'رقم صحيح فقط (1 أو 2 أو 3 أو 4) — يُمنع كتابة اتجاه هنا', 'sort_order': 20},
    {'key': 'facades_directions', 'label': 'اتجاهات الواجهات', 'type': 'text', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'اتجاهات واجهات القطعة نصًا (مثل: شمالية، غربية)', 'sort_order': 21},
