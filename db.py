...
PREBUILT_FIELDS = [
    ...
    {'key': 'building_ratio_setbacks', 'label': 'نسبة البناء والتغطية والارتدادات', 'type': 'textarea', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'يملؤه AI من ملفات الأمانة: نسبة البناء والتغطية، FAR، الارتفاع أو الأدوار المسموحة، والارتدادات الأربعة مع مصدر كل معلومة', 'sort_order': 22},
    ...
    {'key': 'approved_floor_count', 'label': 'الأدوار المعتمدة', 'type': 'number', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'عدد الأدوار الفعلي الذي يعتمده العميل للمبنى — يكتبه العميل فقط ولا يملؤه AI', 'sort_order': 24},
    {'key': 'allowed_uses_restrictions', 'label': 'الاستخدامات المسموحة والقيود التنظيمية', 'type': 'textarea', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'يملؤه AI من ملفات الأمانة: الاستخدامات، القيود، اشتراطات المواقف، المداخل والمخارج، التحميل والخدمات مع المصدر', 'sort_order': 25},
    {'key': 'land_photos', 'label': 'صور الأرض (حتى 4 صور — اختياري)', 'type': 'file', 'required': False, 'section_key': 'land_croquis', 'ai_hint': 'صور فوتوغرافية للأرض من العميل مع وصف لكل صورة (لا يحللها AI)', 'sort_order': 27},
    {'key': 'land_and_building_summary', 'label': 'ملخص بيانات الأرض والاشتراطات', 'type': 'textarea', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'يملؤه AI كملخص موثق من ملفات الأمانة يشمل الارتدادات، المواقف، المداخل والمخارج، الاستخدامات، الفرص، المخاطر والتعارضات', 'sort_order': 28},
    {'key': 'location_address', 'label': 'رابط موقع الأرض في Google Maps', 'type': 'text', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'رابط Google Maps مباشر لنقطة الأرض؛ يستخدم لتحديد الإحداثيات والبلدية والاشتراطات المرتبطة بالموقع', 'sort_order': 10},
