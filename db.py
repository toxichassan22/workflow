...
PREBUILT_FIELDS = [
    ...
    {'key': 'project_level', 'label': 'مستوى المشروع', 'type': 'select', 'options': ['اقتصادي', 'متوسط', 'فوق المتوسط', 'متميز', 'فاخر', 'فائق الفخامة', 'أخرى'], 'required': False, 'section_key': 'basic', 'ai_hint': 'مستوى المنتج من اقتصادي إلى فائق الفخامة، منفصل عن تصنيف النجوم أو فئة المكتب', 'sort_order': 6},
    {'key': 'activity_class', 'label': 'تصنيف النشاط', 'type': 'select', 'options': [], 'required': False, 'section_key': 'basic', 'ai_hint': 'تصنيف الفندق أو فئة المكتب أو مواصفات الصناعي، منفصل عن مستوى المشروع', 'sort_order': 7},
    ...
    {'key': 'approved_coverage_ratio', 'label': 'التغطية المعتمدة (%)', 'type': 'number', 'required': True, 'section_key': 'land_croquis', 'ai_hint': 'نسبة التغطية التي يعتمدها العميل للدراسة المالية — يكتبها العميل فقط ولا يملؤها AI', 'sort_order': 26},
    ...
    {'key': 'city', 'label': 'المدينة', 'type': 'text', 'section_key': 'location', 'ai_hint': 'المدينة المستخرجة من رابط الخرائط ويمكن تعديلها', 'sort_order': 33},
    {'key': 'district', 'label': 'الحي', 'type': 'text', 'section_key': 'location', 'ai_hint': 'الحي المستخرج من رابط الخرائط ويمكن تعديله', 'sort_order': 34},
