...
def draw_icon(c, icon_name, x, y, size, color_hex='#7A0C0C'):
    ...
    if icon_name == 'building':
        c.rect(x-s*0.3,y,s*0.6,s,fill=0,stroke=1)
        c.rect(x-s*0.15,y+s*0.15,s*0.12,s*0.2,fill=1,stroke=0)
        c.rect(x+s*0.03,y+s*0.15,s*0.12,s*0.2,fill=1,stroke=0)
        c.rect(x-s*0.15,y+s*0.5,s*0.12,s*0.2,fill=1,stroke=0)
        c.rect(x+s*0.03,y+s*0.5,s*0.12,s*0.2,fill=1,stroke=0)
    elif icon_name == 'chart_up':
        c.line(x-s*0.4,y,x-s*0.1,y+s*0.3,color_hex,1.5)
        c.line(x-s*0.1,y+s*0.3,x+s*0.15,y+s*0.15,color_hex,1.5)
        c.line(x+s*0.15,y+s*0.15,x+s*0.4,y+s*0.5,color_hex,1.5)
        c.line(x+s*0.4,y+s*0.5,x+s*0.28,y+s*0.45,color_hex,1.5)
        c.line(x+s*0.4,y+s*0.5,x+s*0.35,y+s*0.38,color_hex,1.5)
    elif icon_name == 'chart_bar':
        bw=s*0.15; c.rect(x-s*0.4,y,bw,s*0.3,fill=1,stroke=0)
        c.rect(x-s*0.15,y,bw,s*0.5,fill=1,stroke=0)
        c.rect(x+s*0.1,y,bw,s*0.4,fill=1,stroke=0)
        c.rect(x+s*0.35,y,bw,s*0.7,fill=1,stroke=0)
    elif icon_name in ('money','coin'):
        c.circle(x,y+s*0.35,s*0.35,fill=0,stroke=1)
        c.setFont(ARABIC_FONT,int(s*0.4)); c.drawCentredString(x,y+s*0.15,'$')
    elif icon_name == 'clock':
        c.circle(x,y+s*0.35,s*0.35,fill=0,stroke=1)
        c.line(x,y+s*0.35,x,y+s*0.55); c.line(x,y+s*0.35,x+s*0.15,y+s*0.35)
    elif icon_name in ('location','map_pin'):
        c.circle(x,y+s*0.55,s*0.2,fill=0,stroke=1)
        c.line(x,y+s*0.35,x,y+s*0.1)
    elif icon_name == 'shield':
        p=c.beginPath(); p.moveTo(x,y+s*0.7); p.lineTo(x+s*0.3,y+s*0.55)
        p.lineTo(x+s*0.3,y+s*0.2); p.lineTo(x,y); p.lineTo(x-s*0.3,y+s*0.2)
        p.lineTo(x-s*0.3,y+s*0.55); p.close(); c.drawPath(p,fill=0,stroke=1)
    elif icon_name == 'star':
        import math; pts=[]
        for i in range(10):
            a=math.radians(i*36-90); r=s*0.35 if i%2==0 else s*0.15
            pts.append((x+r*math.cos(a),y+s*0.35+r*math.sin(a)))
        p=c.beginPath(); p.moveTo(pts[0][0],pts[0][1])
        for px,py in pts[1:]: p.lineTo(px,py); p.close(); c.drawPath(p,fill=0,stroke=1)
    elif icon_name == 'check':
        c.setLineWidth(2); c.line(x-s*0.25,y+s*0.3,x-s*0.05,y+s*0.1)
        c.line(x-s*0.05,y+s*0.1,x+s*0.3,y+s*0.5)
    elif icon_name == 'alert':
        p=c.beginPath(); p.moveTo(x,y+s*0.6); p.lineTo(x+s*0.35,y)
        p.lineTo(x-s*0.35,y); p.close(); c.drawPath(p,fill=0,stroke=1)
        c.setFont(ARABIC_FONT,int(s*0.3)); c.drawCentredString(x,y+s*0.15,'!')
    elif icon_name == 'arrow_right':
        c.line(x-s*0.35,y+s*0.3,x+s*0.35,y+s*0.3,color_hex,1.5)
        c.line(x+s*0.15,y+s*0.45,x+s*0.35,y+s*0.3,color_hex,1.5)
        c.line(x+s*0.15,y+s*0.15,x+s*0.35,y+s*0.3,color_hex,1.5)
    elif icon_name == 'arrow_up':
        c.line(x,y,x,y+s*0.6); c.line(x-s*0.15,y+s*0.4,x,y+s*0.6)
        c.line(x+s*0.15,y+s*0.4,x,y+s*0.6)
    elif icon_name == 'target':
        c.circle(x,y+s*0.3,s*0.35,fill=0,stroke=1)
        c.circle(x,y+s*0.3,s*0.2,fill=0,stroke=1)
        c.circle(x,y+s*0.3,s*0.08,fill=1,stroke=0)
    elif icon_name == 'globe':
        c.circle(x,y+s*0.35,s*0.35,fill=0,stroke=1)
        c.line(x-s*0.35,y+s*0.35,x+s*0.35,y+s*0.35)
        c.line(x,y,x,y+s*0.7)
    elif icon_name == 'house':
        p=c.beginPath(); p.moveTo(x,y+s*0.6); p.lineTo(x+s*0.35,y+s*0.3)
        p.lineTo(x+s*0.35,y); p.lineTo(x-s*0.35,y); p.lineTo(x-s*0.35,y+s*0.3)
        p.close(); c.drawPath(p,fill=0,stroke=1)
        c.rect(x-s*0.1,y,s*0.2,s*0.25,fill=0,stroke=1)
    elif icon_name == 'key':
        c.circle(x-s*0.1,y+s*0.4,s*0.15,fill=0,stroke=1)
        c.line(x+s*0.05,y+s*0.4,x+s*0.35,y+s*0.4)
        c.line(x+s*0.25,y+s*0.4,x+s*0.25,y+s*0.3)
        c.line(x+s*0.35,y+s*0.4,x+s*0.35,y+s*0.3)
    elif icon_name == 'leaf':
        p=c.beginPath(); p.moveTo(x,y); p.curveTo(x+s*0.4,y+s*0.1,x+s*0.3,y+s*0.6,x,y+s*0.7)
        p.curveTo(x-s*0.3,y+s*0.6,x-s*0.4,y+s*0.1,x,y); p.close()
        c.drawPath(p,fill=0,stroke=1); c.line(x,y,x,y+s*0.5)
    elif icon_name == 'diamond':
        c.saveState(); c.translate(x,y+s*0.3); c.rotate(45)
        c.rect(-s*0.2,-s*0.2,s*0.4,s*0.4,fill=0,stroke=1); c.restoreState()
    elif icon_name == 'flag':
        c.line(x-s*0.3,y,x-s*0.3,y+s*0.6)
        p=c.beginPath(); p.moveTo(x-s*0.3,y+s*0.6); p.lineTo(x+s*0.2,y+s*0.45)
        p.lineTo(x-s*0.3,y+s*0.3); p.close(); c.drawPath(p,fill=1,stroke=0)
    elif icon_name == 'lightbulb':
        c.circle(x,y+s*0.4,s*0.25,fill=0,stroke=1)
        c.line(x-s*0.08,y+s*0.15,x+s*0.08,y+s*0.15)
        c.line(x-s*0.08,y+s*0.08,x+s*0.08,y+s*0.08)
        c.line(x,y+s*0.65,x,y+s*0.55)
    elif icon_name == 'gear':
        c.circle(x,y+s*0.3,s*0.2,fill=0,stroke=1)
        c.circle(x,y+s*0.3,s*0.35,fill=0,stroke=1)
    elif icon_name == 'phone':
        c.roundRect(x-s*0.15,y,s*0.3,s*0.55,3,fill=0,stroke=1)
        c.line(x-s*0.08,y+s*0.08,x+s*0.08,y+s*0.08)
    elif icon_name == 'mail':
        c.rect(x-s*0.3,y+s*0.1,s*0.6,s*0.4,fill=0,stroke=1)
        c.line(x-s*0.3,y+s*0.5,x,y+s*0.3); c.line(x+s*0.3,y+s*0.5,x,y+s*0.3)
    elif icon_name == 'link':
        c.circle(x-s*0.15,y+s*0.35,s*0.15,fill=0,stroke=1)
        c.circle(x+s*0.15,y+s*0.2,s*0.15,fill=0,stroke=1)
        c.line(x-s*0.05,y+s*0.28,x+s*0.05,y+s*0.27)
    elif icon_name == 'compass':
        c.circle(x,y+s*0.35,s*0.35,fill=0,stroke=1)
        c.line(x,y+s*0.05,x,y+s*0.65); c.line(x-s*0.25,y+s*0.35,x+s*0.25,y+s*0.35)
    elif icon_name == 'people':
        c.circle(x-s*0.15,y+s*0.45,s*0.12,fill=0,stroke=1)
        c.circle(x+s*0.15,y+s*0.45,s*0.12,fill=0,stroke=1)
        c.rect(x-s*0.3,y,s*0.3,s*0.3,fill=0,stroke=1)
        c.rect(x+s*0.05,y,s*0.3,s*0.3,fill=0,stroke=1)
    elif icon_name == 'user':
        c.circle(x,y+s*0.45,s*0.15,fill=0,stroke=1)
        c.rect(x-s*0.2,y,s*0.4,s*0.3,fill=0,stroke=1)
    elif icon_name == 'road':
        c.line(x-s*0.35,y+s*0.5,x+s*0.35,y+s*0.1,color_hex,1.5)
        c.line(x-s*0.25,y+s*0.55,x+s*0.45,y+s*0.15,color_hex,1.5)
    elif icon_name == 'growth':
        c.line(x-s*0.3,y,x+s*0.3,y+s*0.6,color_hex,1.5)
        c.line(x+s*0.1,y+s*0.5,x+s*0.3,y+s*0.6,color_hex,1.5)
        c.line(x+s*0.35,y+s*0.45,x+s*0.3,y+s*0.6,color_hex,1.5)
    c.restoreState()
