...
## 10. وكلاء الذكاء الاصطناعي المستخدمون في التطوير (يملؤها المالك)

> هذا القسم لك: اكتب كل أداة/نموذج/Agent استخدمته أثناء برمجة المشروع، دوره،
> وأبرز ما ساعدك فيه. الجدول جاهز — انسخ الصف الفارغ وكرّره.

| الأداة / الـ Agent | النموذج | دوره في المشروع | أبرز ما ساعد فيه | ملاحظات |
|---|---|---|---|---|
| مثال: Devin | SWE-2 Max | تطوير ميزات وإصلاحات | … | … |
|  |  |  |  |  |
|  |  |  |  |  |
|  |  |  |  |  |
|  |  |  |  |  |
