...
class MeetingRequirementsTests(unittest.TestCase):
    ...
    def test_visual_concept_replaces_legacy_image_workflow_pages(self):
        ...
        self.assertIn("const activeStage = !verified ? 'verify'", index_source)
        self.assertIn("data-plans-workflow-action=\"back-verify\"", index_source)
        self.assertIn("data-plans-workflow-action=\"back-boundary\"", index_source)
