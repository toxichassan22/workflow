...
حدّد الأحجام والأوزان فقط، واستخدم الوزن لخدمة التسلسل البصري لا لتغليظ كل النص:
- عنوان الشريحة: 22px-26px وfont-weight:700 باللون {primary}.
- عنوان القسم أو الجدول: 15px-18px وfont-weight:600 باللون {primary}.
- تسمية الحقل أو المؤشر: 12px-14px وfont-weight:500 باللون {text_color}.
- الفقرات والقيم والوصف وخلايا الجدول: 11px-13px وfont-weight:400 باللون {text_color}.
- الأرقام المالية الرئيسية فقط: 22px-28px وfont-weight:700 باللون {primary}، وتسمياتها بوزن 400 أو 500.
- ممنوع استخدام 700 أو 800 للنصوص الطويلة أو لكل خلايا الجدول، وممنوع خلط أكثر من عائلة خط واحدة.
...
- استخدم رسمًا بيانيًا في الدراسة المالية ومقارنة المنافسين والمراحل عندما توجد قيم رقمية فعلية قابلة للمقارنة.
