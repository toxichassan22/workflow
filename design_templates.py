...
- **تطبيق ألوان الهوية والتناسب المضغوط (Compact & Fitted Tables)**:
  ...
  - **جداول العمودين والمؤشرات (2-Column Key-Value Tables)**:
    ...
    * في الشرائح المالية العادية غير الرسومية، عند وجود أكثر من جدول مالي (مثل «التكاليف والاستثمار» و«مؤشرات العائد»): رص الجداول كلها رأسياً تحت بعضها بترتيبها داخل الشريحة، ولا تضع جدولين بجانب بعضهما. إذا لم تتسع المساحة، أكمل الجداول في الشريحة التالية دون تصغير أو قص أو حذف. شرائح الرسوم المعتمدة فقط تستثنى وتضع جدول بياناتها بجانب الرسم.
