...
## أنواع الرسوم البيانية المدعومة للدراسة المالية (Pure HTML/CSS Executive Charts)
الرسوم ممنوعة خارج الدراسة المالية. داخل الدراسة المالية لا تستخدم إلا `chart_type` المحدد في خطة الشريحة، وبحد أقصى ثلاثة رسوم في العرض كله، مع تنفيذها بـ HTML وCSS نقي:
...
- أضف الرسم فقط إذا حملت خطة الشريحة `chart_type` صريحًا؛ وإلا اعرض جدول التقرير وحده. يبقى جدول البيانات الأصلي كاملًا ومقروءًا بجانب الرسم.
...
- الأرقام القابلة للمقارنة: جدول منظم؛ ولا يضاف رسم إلا في شريحة مالية تحمل `chart_type` محددًا.
...
## الرسوم البيانية المالية المختارة
- الرسوم البيانية ممنوعة خارج قسم الدراسة المالية.
- داخل الدراسة المالية استخدم فقط الرسوم الثلاثة التي تحمل `chart_type` في الخطة، وارسمها بـHTML/CSS فقط بألوان الهوية.
- كل رسم مبني على القيم الموجودة حرفيًا، ويعرض جدول المصدر الكامل والمقروء بجانبه. لا تكرر الرسم ولا تحول القيم المنفردة إلى رسم.
