...
- **تطبيق ألوان الهوية والتناسب المضغوط (Compact & Fitted Tables)**:
  ...
  - **جداول العمودين والمؤشرات (2-Column Key-Value Tables)**:
    ...
    * عند وجود جدولين مترابطين (مثل «التكاليف والاستثمار» و«مؤشرات العائد»): رص الجدولين بجانب بعضهما في عمودين متجاورين (display:grid; grid-template-columns:1fr 1fr; gap:20px; align-items:start;).
